<div class="fixed z-40 inset-0 overflow-y-auto ease-out duration-400 mx-auto">
    <div class="flex items-end z-20 justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form class="w-full" wire:submit.prevent="editNote">
                        ...
                        <div class="max-w-screen-2xl mx-auto">
                            ...
                            <form class="max-w-screen-md grid sm:grid-cols-2 gap-6 mx-auto">
                                ...
                                <div class="sm:col-span-2 flex justify-between items-center gap-3 mt-6">
                                    <button wire:click="editNote()" type="button" class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-green-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                        Save
                                    </button>
                                    <button wire:click="closeEditPopup()" type="button" class="inline-flex justify-center w-3/5 rounded-md border border-transparent px-4 py-2 bg-transparent text-base underline leading-6 font-medium text-gray-600 hover:shadow-sm hover:bg-gray-600 hover:text-white hover:no-underline focus:outline-none focus:border-gray-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                        Cancel
                                    </button>
                                </div>
                            </form>

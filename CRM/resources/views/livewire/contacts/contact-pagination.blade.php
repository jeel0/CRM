<div>
    ...
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center gap-5 py-3">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center pr-8 gap-5">
